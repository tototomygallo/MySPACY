...
def conteo_categorias_con(text: str, modelo="spacy"):
    ...
    if modelo == "spacy":
        ...
        for word, tag in tags:
            ...
            if tag in ["PRP", "PRP$"]: #PPRONS
                ...
                contador['negate'] += 1
            elif tag == "RB" or (tag == "RBR" or tag == "RBS"): #ADVERBS normales, comparativos y superlativos
                contador['adverb'] += 1 #! SOLO MODALES, FALTA INCLUIR LOS VERBOS to be, have y do como AUXVERBS
            elif tag in ["MD"]:
                contador['auxverb'] += 1
            elif tag in ["CC"]:
                contador['conj'] += 1
...
def calculo_LSM_con(conversation: list[str], modelo: str = "spacy") -> float:
    """
    ...
    for line in conversation:
        ...
        counts, wc = conteo_categorias_con(text.strip(), modelo)
